...
def is_handwriting_model_downloaded() -> bool:
    ...
    try:
        ...
        logger.warning(f"Error checking handwriting model status: {e}")
        return False
...
def is_model_downloaded(languages: list[str] = None) -> bool:
    """
