<template>
  <div class="toolbar-group">
    <div class="dropdown-wrapper">
      <button class="toolbar-btn" @click="showImageModal = true" title="이미지 삽입">
          ...
          <div class="image-modal">
            ...
            <div class="image-modal-content">
              ...
              <div class="image-tabs">
                <button class="tab-btn" :class="{ active: imageTab === 'upload' }" @click="imageTab = 'upload'">
                ...
                <button class="tab-btn" :class="{ active: imageTab === 'url' }" @click="imageTab = 'url'">
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
              ...
              <div v-if="imageTab === 'upload'" class="upload-section">
                <div class="upload-dropzone" :class="{ 'drag-over': isUploadDragging }"
                  @dragenter="isUploadDragging = true" @dragleave="isUploadDragging = false" @dragover.prevent
              ...
              <div v-if="imageTab === 'url'" class="input-group">
                ...
                <input v-model="imageUrl" type="text" placeholder="https://example.com/image.jpg"
                  @input="onImageUrlChange" @keydown.enter="confirmInsertImage" />
              </div>
              ...
              <div class="image-preview-container">
                ...
                <img v-else-if="imagePreviewUrl" :src="imagePreviewUrl" class="image-preview" @load="onImageLoad"
                  @error="onImageError" />
            ...
            <div class="image-modal-footer">
              ...
              <button class="btn-insert" :disabled="!finalImageUrl || imageError || isUploading"
