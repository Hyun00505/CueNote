<template>
  <Teleport to="body">
    <div
      v-if="visible"
      class="disconnect-modal-overlay"
    ...
    >
      <div class="disconnect-modal">
        ...
        <div class="disconnect-modal-content">
          ...
          <p class="disconnect-repo-name">
            {{ repoName }}
          </p>
          <p class="disconnect-description">
            {{ t('github.disconnectQuestion') }}
          </p>
        ...
        <div class="disconnect-modal-footer">
          <button
            class="disconnect-btn cancel"
            @click="emit('close')"
          >
            {{ t('common.cancel') }}
          </button>
          <button
            class="disconnect-btn confirm"
            @click="emit('confirm')"
          >
            {{ t('github.disconnectBtn') }}
          </button>
        </div>
      </div>
    </div>
