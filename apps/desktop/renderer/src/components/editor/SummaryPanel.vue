<template>
  <Transition name="slide">
    <div v-if="visible" class="summary-panel">
      <div class="summary-header">
        ...
        <div class="summary-actions">
          ...
          <button class="action-btn insert-btn" @click="emit('insert')" title="노트 상단에 삽입">
      ...
      <div class="summary-content">
        ...
        <div v-if="result.keyPoints.length > 0" class="key-points">
          <h4>핵심 포인트</h4>
          <ul>
            <li v-for="(point, index) in result.keyPoints" :key="index">
              {{ point }}
            </li>
          </ul>
        </div>
